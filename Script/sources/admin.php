		...
		if($loggedIn['username']) {
			...
			if($_GET['b'] == 'security') { // Security Admin Tab
				...
				if(!isset($_GET['id']) && !isset($_GET['idu'])) {
					...
					$TMPL['username'] = '<div class="manage-users-image"><a href="'.$CONF['url'].'/index.php?a=profile&u='.$user['username'].'" target="_blank"><img src="'.$CONF['url'].'/thumb.php?src='.$user['image'].'&t=a&w=112&h=112"></a></div>
